...
[assembly: PreApplicationStartMethod(typeof(testSwaggerConfig), "Register")]

namespace myswaggernet
{
    public class testSwaggerConfig
    {
        public static void Register()
        {
            var thisAssembly = typeof(testSwaggerConfig).Assembly;
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "myswaggernet");
